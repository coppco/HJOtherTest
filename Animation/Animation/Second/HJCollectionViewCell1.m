...
@interface HJCollectionViewCell1 ()
/*图片*/
...
@implementation HJCollectionViewCell1
...
- (void)setup {
    ...
    self.earningsL = ({
        ...
        object.font =[UIFont fontWithName:@"PingFangSC-Light" size:35];
    ...
    [self.earningsL mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self.contentView).offset(-6);
        make.top.mas_equalTo(self.contentView.mas_top).offset(20);
        make.height.mas_equalTo(radio_height(35));
    }];
